...
def create_report():
    ...
    add_body("http://10.1.75.51:5237/analyzeContour (and http://10.1.75.51:5237/findCatchment)", "Working Live API Route URL: ")
    add_body("http://10.1.75.51:5237/", "Live Dashboard URL: ")
